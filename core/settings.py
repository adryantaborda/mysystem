...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # <- GARANTA QUE ESSA LINHA EXISTE
],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
